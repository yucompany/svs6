  ...
  populate(letters){
    ...
    for(let i = 0; i < letters.length; i++){
      ...
      if(i < letters.length-1)
        kern = Kerning[CHARTABLE[letters[i]].shape + CHARTABLE[letters[i+1]].shape] * SPACING * this.segment * len; // Append shape constants to lookup kerning in table
